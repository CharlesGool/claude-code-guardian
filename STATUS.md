...
**Next:** leave an instance idle overnight and record whether v0.6.2 also goes unreachable — that result decides whether the withdrawn Remote Control work is recovered.
**Known issues:**
